...
namespace File.Infrastructure
{
    public class FileContext : DbContext, IUnitOfWork
    {
        ...
        private FileContext(DbContextOptions<FileContext> options) : base(options) { }

        public IDbContextTransaction GetCurrentTransaction() => _currentTransaction;

        public bool HasActiveTransaction => _currentTransaction != null;

        public FileContext(DbContextOptions<FileContext> options, IMediator mediator) : base(options)
        {
